...
- Running the upstream-only driver inside `unified_pipeline_clean/nif_hdk_scan_release_clean`
  also honors `--assembly-levels "complete genome"` (or `export NIF_ASSEMBLY_LEVELS="complete genome"`).
